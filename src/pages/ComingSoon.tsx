        ...
        <div className="container-wide py-16 md:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              <div className="inline-block px-4 py-2 bg-colink-teal/10 text-colink-teal rounded-full text-sm font-medium mb-2">
                Coming Soon
              </div>
          ...
          <div className="mt-24">
            <h2 className="text-2xl font-bold text-center mb-12">Trusted by Innovative Businesses</h2>
        ...
        <div className="container-wide">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              &copy; {new Date().getFullYear()} CoLink Venture. All rights reserved.
            </p>
